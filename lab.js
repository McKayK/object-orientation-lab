...
favoriteThings.car = '1966 Mustang'
favoriteThings.show = 'Third Rock from the Sun'
...
const final = totalPopulation(test)
// console.log(final)
...
const newArr = ingredients(health)
// console.log(newArr)
...
const myCat = new Cat('Garfield', 55, 'Orange')
...
const myWizard = new Wizard('Dracon', 35, 'Chain Lightning')
// myWizard.castSpell()
...
const iphoneX = new Phone('Apple', 'iphone', 256, 'Green', 1000)
const samsung = new Phone('Samsung', 'Galaxy', 512, 'Black', 900)
const pixel6 = new Phone('Google', 'Pixel', 128, 'White', 600)
...
const myFirstVehicle = new Vehicle(4, 'green', 100000)
...
const myFirstMotorcycle = new Motorcycle(1, 'blue', 500, 'Honda', true)
...
const myFirstBoat = new Boat(10, 'White', 1000, 'Lightning', 'Boat', false)
